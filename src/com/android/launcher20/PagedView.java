...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected static int MAX_PAGE_SNAP_DURATION = 750;
    ...
    private static int MIN_SNAP_VELOCITY = 1500;
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        PAGE_SNAP_ANIMATION_DURATION = r.getInteger(R.integer.config_PageSnapAnimationDuration);
        MAX_PAGE_SNAP_DURATION       = r.getInteger(R.integer.config_MaxPageSnapDuration);
        MIN_SNAP_VELOCITY            = r.getInteger(R.integer.config_MinSnapVelocity);
