...
public class BubbleTextView extends TextView {
    ...
    private boolean mDisablePressedIconBackground = false;
    ...
    private void init() {
        ...
        mDisablePressedIconBackground = getResources().getBoolean(R.bool.config_DisablePressedIconBackground);
    ...
    protected void drawableStateChanged() {
        if (isPressed()) {
            ...
            if (isFocused()) {
                if (!mDisablePressedIconBackground) {
                    if (getLayout() == null) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // to create it)
                if (mPressedOrFocusedBackground == null && !mDisablePressedIconBackground) {
                    mPressedOrFocusedBackground = createGlowingOutline(
    ...
    void setCellLayoutPressedOrFocusedIcon() {
        if ((getParent() instanceof ShortcutAndWidgetContainer) && !mDisablePressedIconBackground) {
