...
public final class Launcher extends Activity
        ...
        View.OnTouchListener ,PositionChangeListener,OnAppWidgetHostViewPosiChangeListener{
    ...
    private final int BOOSTUPERF_TIMER_PERIOD = 3*1000;
...
//            Log.d("down","x"+ev.getRawX()+" y"+ev.getRawY());
            mDragLayer.onInterceptTouchEvent(ev);
            mWorkspace.onInterceptTouchEvent(ev);
            savecellview.onInterceptTouchEvent(ev);

//            savecellview.onTouchEvent(ev);

//            mDragController.onTouchEvent(ev.getRawX(),ev.getRawY(),ev);
        }
...
//            if(saveview instanceof CellLayout&&longClickCellInfo==null) {
//                ((CellLayout) saveview).setTagToCellInfoForPoint((int) (ev.getRawX()), (int) (ev.getRawY()));
////                ((CellLayout) saveview).setTagToCellInfoForPoint(floatService.getWidgetX(), floatService.getWidgetY());
//            }
//            savecellview.onInterceptTouchEvent(ev);
            mWorkspace.setAllowLongPress(true);
            Launcher.this.onLongClick(saveview);
//            floatService.cnTouch(false);
            mDragLayer.onTouchEvent(ev);
        }
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter.addAction("com.android.launcher20.MY_BROADCAST");
//        myBroadcastRe = new MyBroadcastRe();
...
//        addFloatWin();
        ...
        mModel.setPositionChangetListener(this);

    }

    protected void onUserLeaveHint() {
        super.onUserLeaveHint();
        Log.d("Launcher","onUserLeaveHint");
        sPausedFromUserAction = true;
    }

    private void updateGlobalIcons() {
        Log.d("Launcher","updateGlobalIcons");
    ...
    private void checkForLocaleChange() {
        Log.d("Launcher","checkForLocaleChange");
    ...
    private static void readConfiguration(Context context, LocaleConfiguration configuration) {
        Log.d("Launcher","readConfiguration");
    ...
    private static void writeConfiguration(Context context, LocaleConfiguration configuration) {
        Log.d("Launcher","writeConfiguration");
    ...
    private void completeTwoStageWidgetDrop(final int resultCode, final int appWidgetId) {
        Log.d("Launcher","completeTwoStageWidgetDrop");
...
//        floatService.onPause();
    ...
    */
    ...
    void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
        Log.d("Launcher","completeAddApplication");
    ...
    private void completeAddShortcut(Intent data, long container, int screen, int cellX,
                                     ...
                                     int cellY) {
        Log.d("Launcher","completeAddShortcut");
    ...
    static int[] getSpanForWidget(Context context, ComponentName component, int minWidth,
                                  int minHeight) {
        Log.d("Launcher","getSpanForWidget");
    ...
    static int[] getMinSpanForWidget(Context context, AppWidgetProviderInfo info) {
        Log.d("Launcher","getMinSpanForWidget");
    ...
    private void completeAddAppWidget(final int appWidgetId, long container, int screen,
        ...
        Log.d("Launcher","completeAddWidget");
        this.finalWidgetId = appWidgetId;
        ...
        Log.d("complete","x"+cellXY[0]+" y"+cellXY[1]);
        if(flagWidget){

//            saveid = appWidgetId;
//            saveposi[0]=cellXY[0];
//            saveposi[1]=cellXY[1];
//            saveAppInfo= appWidgetInfo;
            SaveWidgetif((int)launcherInfo.id,cellXY[0],cellXY[1],layout);
            Log.d("add","x"+spanXY[0]+" y"+spanXY[1]);
            Log.d("add2","x"+saveposi[0]+" y"+saveposi[1]);
//            if( saveposi[0]==0&&saveposi[1]==0){
//                NaviStart3Activity naviStart3Activity1 = new NaviStart3Activity(Launcher.this,savecellview.getWindowToken());
...
//            naviStart3Activity1.onStart(saveposi[1]);
    ...
    private CellLayout savecellview;
    private void SaveWidgetif(int appWidgetId,int posiX,int posiY,CellLayout cellLayout){
        saveid = appWidgetId;
        saveposi[0]=posiX;
        saveposi[1]=posiY;
//        saveAppInfo= appWidgetInfo;
        savecellview=cellLayout;
        saveview=cellLayout;

        mSharedPreferences = getSharedPreferences("myown",Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putInt("id",appWidgetId);
        editor.putInt("posix",posiX);
        editor.putInt("posiy",posiY);
        editor.commit();
    }
    private void createFloatWindow(){

    }
    private int[] saveposi = {100,100};
    ...
    public void onWindowVisibilityChanged(int visibility) {
        Log.d("Launcher","onWindowVisibilityChanged");
    ...
    private void sendAdvanceMessage(long delay) {
        Log.d("Launcher","sendAdvanceMessage");
    ...
    void addWidgetToAutoAdvanceIfNeeded(View hostView, AppWidgetProviderInfo appWidgetInfo) {
        Log.d("Launcher","addWidgetToAutoAdvanceIfNeeded");
    ...
    void removeWidgetToAutoAdvance(View hostView) {
        Log.d("Launcher","removeWidgetToAutoAdvance");
    ...
    public void removeAppWidget(LauncherAppWidgetInfo launcherInfo) {
        Log.d("Launcher","removeAppWidget");
        removeWidgetToAutoAdvance(launcherInfo.hostView);
        launcherInfo.hostView = null;
    }

    void showOutOfSpaceMessage(boolean isHotseatLayout) {
        Log.d("Launcher","showOutOfSpaceMessage");
...
//        unregisterReceiver(myBroadcastRe);
        mDragLayer.clearAllResizeFrames();
    ...
    public void startGlobalSearch(String initialQuery,
        ...
        Log.d("Launcher","startGlobalSearch");
    ...
    private int saveid=10000;
    private ItemInfo saveinfo;
    private AppWidgetProviderInfo saveAppInfo;

    void addAppWidgetImpl(final int appWidgetId, ItemInfo info, AppWidgetHostView boundWidget,
                          AppWidgetProviderInfo appWidgetInfo) {
        Log.d("Launcher","addWidgetImpl");
    ...
    void processShortcutFromDrop(ComponentName componentName, long container, int screen,
                                 int[] cell, int[] loc) {
        Log.d("Launcher","processShortcutFromDrop");
        resetAddInfo();
    ...
    void addAppWidgetFromDrop(PendingAddWidgetInfo info, long container, int screen,
        ...
        Log.d("Launcher","addAppWidgetFromDrop");
        resetAddInfo();
    ...
    void processShortcut(Intent intent) {
        Log.d("Launcher","processShortcut");
...
//        Log.d("Launcher","startWallpaper");
    ...
    void startApplicationDetailsActivity(ComponentName componentName) {
        Log.d("Launcher","startApplicationDetailsActivity");
    ...
    private void handleFolderClick(FolderIcon folderIcon) {
        Log.d("Launcher","handleFolderClick");
    ...
    private void copyFolderIconToImage(FolderIcon fi) {
        Log.d("Launcher","copyFolderIconToImage");
    ...
    private void growAndFadeOutFolderIcon(FolderIcon fi) {
        Log.d("Launcher","growAndFadeOutFolderIcon");
        if (fi == null) return;
    ...
    private void shrinkAndFadeInFolderIcon(final FolderIcon fi) {
        Log.d("Launcher","shrinkAndFadeInFolderIcon");
        if (fi == null) return;
    ...
    public boolean onLongClick(View v) {
        Log.d("Launcher","onLongClick1 "+v.toString());
        ...
        if (!(v instanceof CellLayout)) {
            ...
            Log.d("Launcher","onLongClick2 "+v.toString());
        }
        ...
        else Log.d("test","istrue");

        // The hotseat touch handling does not go through Workspace, and we always allow long press
        // on hotseat items.
        final View itemUnderLongClick = longClickCellInfo.cell;
        boolean allowLongPress = isHotseatLayout(v) || mWorkspace.allowLongPress();
        Log.d("Launcher","v "+isHotseatLayout(v)+" "+mWorkspace.allowLongPress()+"  "+mDragController.isDragging());
...
//        Log.d("Launcher","isHotseatLayout");
    ...
    private void showAppsCustomizeHelper(final boolean animated, final boolean springLoaded) {
        Log.d("Launcher","showAppsCustomizeHelper");
    ...
    private void hideAppsCustomizeHelper(State toState, final boolean animated,
        ...
        Log.d("Launcher","hideAppsCustomizeHelper");
    ...
    void showWorkspace(boolean animated, Runnable onCompleteRunnable) {
        ...
        startTimer_boostUperf();
        if (mAppsCustomizeContent != null && mLoaded == false) {
            mAppsCustomizeContent.onPackagesUpdated(
                    LauncherModel.getSortedWidgetsAndShortcuts(this));
            mLoaded = true;
        }
...
//        if(floatService!=null)if (!floatService.isMiss())floatService.onDismiss();
    ...
    void exitSpringLoadedDragModeDelayed(final boolean successfulDrop, boolean extendedDelay,
        ...
        Log.d("Launcher","exitSpringLoadedDragModeDelayed");
    ...
    void exitSpringLoadedDragMode() {
        Log.d("Launcher","exitSpringLoadedDragMode");
    ...
    void hideDockDivider() {
        Log.d("Launcher","hideDockDivider");
    ...
    void showDockDivider(boolean animated) {
        Log.d("Launcher","showDockDivider");
        if (mQsbDivider != null && mDockDivider != null) {
...
//        if(floatService!=null)if (floatService.isMiss())floatService.reShow();
    ...
    private int getCurrentOrientationIndexForGlobalIcons() {
        Log.d("Launcher","getCurrentOrientationIndexForGlobalIcons");
    ...
    private Drawable getExternalPackageToolbarIcon(ComponentName activityName, String resourceName) {
        Log.d("Launcher","getExternalPackageToolbarIcon");
        try {
    ...
    private Drawable.ConstantState updateTextButtonWithIconFromExternalActivity(
        ...
        Log.d("Launcher","updateTextButtonWithIconFromExternalActivity");
    ...
    private Drawable.ConstantState updateButtonWithIconFromExternalActivity(
            int buttonId, ComponentName activityName, int fallbackDrawableId,
            String toolbarResourceName) {
        Log.d("Launcher","updateButtonWithIconFromExternalActivity");
    ...
    private void updateAppMarketIcon() {
        Log.d("Launcher","updateAppMarketIcon");
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        Log.d("Launcher","dispatchPopulateAccessibilityEvent");
...
//            }
    ...
    private void runNewAppsAnimation(boolean immediate) {
        Log.d("Launcher","runNewAppsAnimation");
    ...
    public void bindAllApplications(final ArrayList<ApplicationInfo> apps) {
        Log.d("Launcher","bindAllApplications");
    ...
    public void bindComponentsRemoved(final ArrayList<String> packageNames,
        ...
        Log.d("Launcher","bindComponentsRemoved");
        if (waitUntilResume(new Runnable() {
            public void run() {
    ...
    private int mapConfigurationOriActivityInfoOri(int configOri) {
        Log.d("Launcher","mapConfigurationOriActivityInfoOri");
...
//        naviStart3Activity.onStart(0);
    ...
    public void changeSaveView(View cellLayout){
        Log.d("Launcher","changeSaveView  "+cellLayout.toString());
        saveview = cellLayout;
    }
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
//            Launcher.this.addFloatWin();
            Log.d(TAG,"i have receive");
            int style=intent.getIntExtra("xxx",2);
            if(style==0){
                flagWidget = true;}
            else if(style==1){
//                floatService.close();
    ...
    @Override
    public void positionChange(int id, int x, int y) {
        Log.d("Launcher","id:"+id);
        mSharedPreferences = getSharedPreferences("myown",Context.MODE_PRIVATE);
