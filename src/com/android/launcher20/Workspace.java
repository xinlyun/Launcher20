...
import com.android.launcher20.LauncherSettings.Favorites;
...
//        Log.d("Workspace","onInterceptTouchEvent");
...
//                    mLauncher.changeSaveView(lahv);
    ...
    */
    ...
    public void beginDragShared(View child, DragSource source) {
        Log.d("Workspace","beginDragShared"+"  "+child.getClass().toString());
        ...
        if ((child instanceof BubbleTextView) && !disablePressedIconBackground) {
...
//        mLauncher.changeSaveView(dropTargetLayout);
            ...
            if (dropTargetLayout != null) {
                ...
                if (foundCell) {
                    ...
                    if (container != LauncherSettings.Favorites.CONTAINER_HOTSEAT &&
                        ...
                        mLauncher.changeSaveView(hostView);
...
//       Log.d(TAG,"mapmapPointFromSelfToChild  v:"+v.getClass().toString()+" x:"+xy[0]+" y:"+xy[1]);
...
//        Log.d("Workspace","onDragOver");
        ...
        if (mDragTargetLayout != null) {
            ...
            final View dragOverView = mDragTargetLayout.getChildAt(mTargetCell[0],
                    mTargetCell[1]);
//            Log.d(TAG,"onDragOver"+dragOverView.getClass().toString());
    ...
    public boolean addExternalItemToScreen(ItemInfo dragInfo, CellLayout layout) {
        Log.d("Workspace","addExternalItemToScreen");
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        Log.d("Workspace","onDropExternal");
...
//            mLauncher.changeSaveView(cellLayout);
        }
    ...
    void updateItemLocationsInDatabase(CellLayout cl) {
        Log.d("Workspace","updateItemLocationsInDatabase");
