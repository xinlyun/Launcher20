...
import com.android.launcher20.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
...
public class LauncherModel extends BroadcastReceiver {
    ...
    static void moveItemInDatabase(Context context, final ItemInfo item, final long container,
        ...
        String transaction = "DbDebug    Modify item (" + item.title + ") in db, id: " + item.id +
                ...
                ") --> " + "(" + container + ", " + screen + ", " + cellX + ", " + cellY + ")";
        positionChangeListener.positionChange((int) item.id,cellX,cellY);
    ...
    static void modifyItemInDatabase(Context context, final ItemInfo item, final long container,
        ...
        String transaction = "DbDebug2    Modify item (" + item.title + ") in db, id: " + item.id +
                " (" + item.container + ", " + item.screen + ", " + item.cellX + ", " + item.cellY +
                ") --> " + "(" + container + ", " + screen + ", " + cellX + ", " + cellY + ")";

        positionChangeListener.positionChange((int) item.id,item.cellX,item.cellY);
//        Launcher.sDumpLogs.add(transaction);
        Log.d(TAG, transaction);
        item.cellX = cellX;
        item.cellY = cellY;
    ...
    private static PositionChangeListener positionChangeListener;
    public void setPositionChangetListener(PositionChangeListener positionChangetListener){
        this.positionChangeListener = positionChangetListener;
    }
}
interface PositionChangeListener{
    void positionChange(int id,int x,int y);
}